...
const galleryItems = [
  ...
  { label:'🏫 Our Classroom',           size:'small', img:'/photos/classroom.jpeg' },
  { label:'👨‍🎓 Our Students',          size:'small', img:'/photos/grouphoto.webp' },
  { label:'🎯 Expert Teaching',         size:'small', img:'/photos/classroom1.jpeg' },
  { label:'🏆 Achievements',            size:'small', img:'/photos/unnamed3.webp' },
